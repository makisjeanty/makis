    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.CharField(default='Analista de Sistemas', max_length=200, verbose_name='Cargo atual')),
                ('bio', models.TextField(blank=True, max_length=1000, verbose_name='Biografia')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='perfis/')),
